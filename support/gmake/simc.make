...
ifeq ($(config),debug32)
  ...
  INCLUDES  += -I../../include -I../../external/tinyxml
...
ifeq ($(config),debugsinglethread32)
  OBJDIR     = obj/x32/DebugSingleThread
  TARGETDIR  = ../../bin
...
ifeq ($(config),releasesinglethread32)
  OBJDIR     = obj/x32/ReleaseSingleThread
  TARGETDIR  = ../../bin
...
ifeq ($(config),debugsinglethreaddynamic32)
  OBJDIR     = obj/x32/DebugSingleThreadDynamic
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libsimc_std32.a
...
ifeq ($(config),releasesinglethreaddynamic32)
  OBJDIR     = obj/x32/ReleaseSingleThreadDynamic
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libsimc_st32.a
...
ifeq ($(config),debugsinglethread64)
  OBJDIR     = obj/x64/DebugSingleThread
  TARGETDIR  = ../../bin
...
ifeq ($(config),releasesinglethread64)
  OBJDIR     = obj/x64/ReleaseSingleThread
  TARGETDIR  = ../../bin
...
ifeq ($(config),debugsinglethreaddynamic64)
  OBJDIR     = obj/x64/DebugSingleThreadDynamic
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libsimc_std.a
...
ifeq ($(config),releasesinglethreaddynamic64)
  OBJDIR     = obj/x64/ReleaseSingleThreadDynamic
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libsimc_st.a
...
$(OBJDIR)/sim_curtime.o: ../../source/sim_curtime.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/sim_linkedlist.o: ../../source/sim_linkedlist.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/sim_queue.o: ../../source/sim_queue.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/sim_threading.o: ../../source/sim_threading.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/sim_xml.o: ../../source/sim_xml.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
